...
export default function SignupPage() {
  ...
  return (
    <div className="signup-page">
      <Container component="main" maxWidth="md" className="container" style={{ marginTop: '30px', marginBottom: '30px' }}>
        <Grid container>
          <CssBaseline />
          <Grid
            item
                ...
                <Grid container>
                  <Grid item>
                    <RouterLink to="/login" style={{ textDecoration: 'none' }}>
                      <Typography variant="body2" sx={{ paddingLeft: '8px' }}><u>Already have an account? Sign In</u></Typography>
                    </RouterLink>
                  </Grid>
                </Grid>
              </Box>
